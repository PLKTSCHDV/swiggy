...
<body>
  ...
  <img src="pics\s.png" length=55 width=55 align="bottom">&nbsp&nbsp
    <center><font color="#E67E22" size="10%" face="microsoft jhenghei"><b>WELCOME ADMIN</b></font></center>
    <hr color="white">
...
<div class="sreset">
            <form action="doneall">
                <input type="submit" class="bx" value="done all">
            </form>
        </div>
        ...
        <%
 ...
 else 
            {
                 ...
                 %>
                 NOTHING IS PURCHASE CART RIGHT NOW.
                 <%
